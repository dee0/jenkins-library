...
stepMetadata:
  artifactPrepareVersion: dee0-versioning.yaml
containerMaps:
  init:
...
"""
    ...
    void init() {
        ...
        shellCallRule.setReturnValue('./piper getConfig --contextConfig --stepMetadata \'.pipeline/tmp/metadata/dee0-versioning.yaml\'', '{"dockerImage":"artifact-image"}')
    }
